...
function(llvm_ExternalProject_Add name source_dir)
  ...
  # Normalize the runtime output path so single-config generators don't pass
  # toolchain paths with "/./" segments that force an unnecessary cache reset.
  set(llvm_runtime_output_intdir "${LLVM_RUNTIME_OUTPUT_INTDIR}")
  if(llvm_runtime_output_intdir)
    cmake_path(NORMAL_PATH llvm_runtime_output_intdir
               OUTPUT_VARIABLE llvm_runtime_output_intdir)
  endif()
